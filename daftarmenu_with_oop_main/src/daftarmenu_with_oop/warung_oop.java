...
public class warung_oop {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            case 7:
            System.out.println();
            System.out.println("Anda Membatalkan Pemesanan, Tidak Jadi Memesan , Tidak bawa Uang !");
            System.out.println();
            System.out.println();
            System.exit(0);
        ...
        System.out.println("Ingin Menambah Pesanan? / Mengakhiri Pesanan ?");
            ...
            System.out.println();
            System.out.println("Terimakasih Telah Datang Dan Memesan Di Lesehan Bujang Belitong");
            System.out.println();
            System.out.println();
            input.close();
